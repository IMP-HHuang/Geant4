...
int main(int argc, char** argv)
{
	...
	Person_DetectorConstruction* DetectorConstruction = new Person_DetectorConstruction();
	...
	Person_ActionInitialization* ActionInit = new Person_ActionInitialization(DetectorConstruction);
