  	...
  	fParticleGunAlpha(0)
{
    ...
    G4ParticleDefinition* particleDef = ionTable->GetIon(11, 22, 0);

    /*
    gpsNa22 = new G4GeneralParticleSource();
    if(particleDef != 0)
        gpsNa22->GetCurrentSource()->SetParticleDefinition(particleDef);  
	else
		std::cout << "\033[31m Cannot get Na-22 source \033[0m" << std::endl;
    */
